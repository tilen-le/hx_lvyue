        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item style="width:100%;text-align: right">
              <el-button type="primary" icon="el-icon-search" size="mini" @click="handleQuery" v-hasPermi="['customer:list:query']">查询</el-button>
              <el-button icon="el-icon-refresh" size="mini" @click="resetQuery" v-hasPermi="['customer:list:reset']">重置</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
        ...
        >
          <template slot-scope="scope" v-if="scope.row.userId !== 1">
            <el-button
              ...
              v-hasPermi="['customer:list:detail']"
            >详情
            </el-button>
          </template>
        </el-table-column>
