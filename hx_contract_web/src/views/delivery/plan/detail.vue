...
<!--      详细信息-->
      <div class="plan-header" style="padding-right: 10px;padding-left: 10px">
        ...
        <el-descriptions column="1" >
          <el-descriptions-item label="实际开船日">{{ planForm.actualDepartureDate }}</el-descriptions-item>
          <el-descriptions-item label="货物完成时间及地点">{{ planForm.goodsCompleteDateAndLocate }}</el-descriptions-item>
          <el-descriptions-item label="保险条款">{{ planForm.insuranceClauses }}</el-descriptions-item>
          <el-descriptions-item label="特殊要求">{{ planForm.specialRequirements }}</el-descriptions-item>
          <el-descriptions-item label="备注">{{ planForm.remark }}</el-descriptions-item>
          <el-descriptions-item label="报清关差异原因">{{ planForm.reportCustomsClearanceReason }}</el-descriptions-item>
        </el-descriptions>
      </div>
      <div class="plan-header" style="padding-right: 10px;padding-left: 10px">
