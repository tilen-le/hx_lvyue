...
import com.hexing.pay.controller.admin.merchant.vo.merchant.PayMerchantExportReqVO;
import com.hexing.pay.controller.admin.merchant.vo.merchant.PayMerchantPageReqVO;
import com.hexing.pay.controller.admin.merchant.vo.merchant.PayMerchantUpdateReqVO;
import com.hexing.pay.convert.merchant.PayMerchantConvert;
...
public class PayMerchantServiceImpl implements PayMerchantService {
    ...
    public void checkMerchantExists(Long id) {
        ...
        if (merchant == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PAY_MERCHANT_NOT_EXISTS);
        }
    }
    ...
    private void validateAppExists(Long id) {
        if (appMapper.selectCount(id) > 0) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PAY_MERCHANT_EXIST_APP_CANT_DELETE);
        }
    }
