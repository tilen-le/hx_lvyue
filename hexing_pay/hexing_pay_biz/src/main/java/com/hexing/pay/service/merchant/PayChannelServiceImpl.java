...
import com.hexing.pay.controller.admin.merchant.vo.channel.PayChannelCreateReqVO;
import com.hexing.pay.controller.admin.merchant.vo.channel.PayChannelExportReqVO;
import com.hexing.pay.controller.admin.merchant.vo.channel.PayChannelPageReqVO;
import com.hexing.pay.controller.admin.merchant.vo.channel.PayChannelUpdateReqVO;
import com.hexing.pay.convert.channel.PayChannelConvert;
import com.hexing.pay.core.client.PayClientConfig;
import com.hexing.pay.core.client.PayClientFactory;
import com.hexing.pay.core.enums.PayChannelEnum;
import com.hexing.pay.dal.dataobject.merchant.PayChannelDO;
import com.hexing.pay.dal.mysql.merchant.PayChannelMapper;
...
public class PayChannelServiceImpl implements PayChannelService {
    ...
    private void validateChannelExists(Long id) {
        if (channelMapper.selectById(id) == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.CHANNEL_NOT_EXISTS);
        }
    }
