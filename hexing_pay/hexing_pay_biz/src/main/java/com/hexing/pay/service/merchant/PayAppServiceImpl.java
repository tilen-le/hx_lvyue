package com.hexing.pay.service.merchant;
...
import com.hexing.pay.controller.admin.merchant.vo.app.PayAppCreateReqVO;
import com.hexing.pay.controller.admin.merchant.vo.app.PayAppExportReqVO;
import com.hexing.pay.controller.admin.merchant.vo.app.PayAppPageReqVO;
import com.hexing.pay.controller.admin.merchant.vo.app.PayAppUpdateReqVO;
import com.hexing.pay.convert.app.PayAppConvert;
import com.hexing.pay.dal.dataobject.merchant.PayAppDO;
import com.hexing.pay.dal.dataobject.merchant.PayMerchantDO;
import com.hexing.pay.dal.mysql.merchant.PayAppMapper;
import com.hexing.pay.dal.mysql.merchant.PayMerchantMapper;
...
public class PayAppServiceImpl implements PayAppService {
    ...
    private void validateOrderTransactionExist(Long appId) {
        ...
        if (orderMapper.selectCount(appId, PayOrderStatusEnum.WAITING.getStatus()) > 0) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PAY_APP_EXIST_TRANSACTION_ORDER_CANT_DELETE);
        }
        // 查看退款订单
