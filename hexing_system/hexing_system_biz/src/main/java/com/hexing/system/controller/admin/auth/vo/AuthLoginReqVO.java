package com.hexing.system.controller.admin.auth.vo;

import cn.hutool.core.util.StrUtil;
import com.hexing.common.validation.InEnum;
import com.hexing.system.enums.social.SocialTypeEnum;
...
public class AuthLoginReqVO {
    ...
    @Schema(description = "账号", required = true, example = "hexingyuanma")
