package com.hexing.system.mq.producer.permission;

import com.hexing.system.mq.message.permission.RoleMenuRefreshMessage;
import com.hexing.mq.core.RedisMQTemplate;
import com.hexing.system.mq.message.permission.UserRoleRefreshMessage;
