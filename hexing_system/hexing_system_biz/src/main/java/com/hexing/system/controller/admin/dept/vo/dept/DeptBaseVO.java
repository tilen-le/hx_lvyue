package com.hexing.system.controller.admin.dept.vo.dept;
...
public class DeptBaseVO {
    ...
    @Schema(description = "菜单名称", required = true, example = "hexing")
    ...
    @Schema(description = "邮箱", example = "hexing@iocoder.cn")
