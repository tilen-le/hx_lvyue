package com.hexing.system.service.user;
...
import com.hexing.base.api.file.FileApi;
...
import com.hexing.datapermission.core.util.DataPermissionUtils;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:1234qwer}")
