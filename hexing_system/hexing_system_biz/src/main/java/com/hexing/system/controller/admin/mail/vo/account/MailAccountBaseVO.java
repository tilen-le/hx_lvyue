package com.hexing.system.controller.admin.mail.vo.account;
...
public class MailAccountBaseVO {
    ...
    @Schema(description = "邮箱", required = true, example = "hexingyuanma@123.com")
    @NotNull(message = "邮箱不能为空")
    @Email(message = "必须是 Email 格式")
    private String mail;

    @Schema(description = "用户名", required = true, example = "hexing")
