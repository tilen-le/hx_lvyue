package com.hexing.system.controller.admin.oauth2.vo.user;
...
public class OAuth2UserInfoRespVO {
    ...
    @Schema(description = "用户昵称", required = true, example = "hexing")
    private String nickname;

    @Schema(description = "用户邮箱", example = "firerock_tech@163.com")
