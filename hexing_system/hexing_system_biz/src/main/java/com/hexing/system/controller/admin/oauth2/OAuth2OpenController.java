package com.hexing.system.controller.admin.oauth2;
...
import com.hexing.common.util.http.HttpUtils;
import com.hexing.common.util.json.JsonUtils;
import com.hexing.operatelog.core.annotations.OperateLog;
import com.hexing.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
...
import com.hexing.system.service.oauth2.OAuth2GrantService;
import com.hexing.system.service.oauth2.OAuth2TokenService;
import com.hexing.system.util.oauth2.OAuth2Utils;
...
import static com.hexing.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
...
import static com.hexing.common.util.collection.CollectionUtils.convertList;
