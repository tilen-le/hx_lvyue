package com.hexing.system.service.tenant;
...
import com.hexing.tenant.config.TenantProperties;
...
import com.hexing.system.dal.mysql.tenant.TenantMapper;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 hexing.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
