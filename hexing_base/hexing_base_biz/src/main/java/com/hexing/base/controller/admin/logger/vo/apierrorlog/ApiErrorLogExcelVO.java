package com.hexing.base.controller.admin.logger.vo.apierrorlog;

import com.hexing.excel.core.annotations.DictFormat;
import com.hexing.excel.core.convert.DictConvert;
import com.hexing.base.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(com.hexing.system.enums.DictTypeConstants.USER_TYPE)
