package com.hexing.base.service.codegen.inner;
...
import com.hexing.common.util.date.LocalDateTimeUtils;
...
import com.hexing.base.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "hexing-module-${table.moduleName}/" + // 顶级模块
                "hexing-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "hexing-module-${table.moduleName}/" + // 顶级模块
                "hexing-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "hexing-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "hexing-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}
