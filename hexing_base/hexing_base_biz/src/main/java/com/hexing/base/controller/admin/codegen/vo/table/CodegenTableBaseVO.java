...
public class CodegenTableBaseVO {
    ...
    @Schema(description = "表名称", required = true, example = "hexing")
    @NotNull(message = "表名称不能为空")
    private String tableName;

    @Schema(description = "表描述", required = true, example = "hexing")
    ...
    @Schema(description = "作者", required = true, example = "firerock_tech")
