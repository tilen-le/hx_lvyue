package com.hexing.operatelog.core.aop;
...
import com.hexing.operatelog.core.enums.OperateTypeEnum;
import com.hexing.operatelog.core.service.OperateLog;
import com.hexing.operatelog.core.service.OperateLogFrameworkService;
import com.hexing.web.web.core.util.WebFrameworkUtils;
...
import static com.hexing.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.hexing.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.hexing.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.hexing.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.hexing.operatelog.core.annotations.OperateLog operateLog,
