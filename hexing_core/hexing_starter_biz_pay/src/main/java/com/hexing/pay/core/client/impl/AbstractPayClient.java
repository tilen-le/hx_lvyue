package com.hexing.pay.core.client.impl;
...
import com.hexing.pay.core.client.dto.refund.PayRefundUnifiedRespDTO;
import com.alipay.api.AlipayResponse;
import com.hexing.pay.core.enums.PayFrameworkErrorCodeConstants;
...
import static com.hexing.common.exception.util.ServiceExceptionUtil.exception0;
...
public abstract class AbstractPayClient<Config extends PayClientConfig> implements PayClient {
    ...
    protected void validateSuccess(AlipayResponse response) {
        ...
        throw exception0(PayFrameworkErrorCodeConstants.PAY_EXCEPTION.getCode(), response.getSubMsg());
    }
