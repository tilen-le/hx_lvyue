package com.hexing.tracer.config;

import com.hexing.common.enums.WebFilterOrderEnum;
import com.hexing.tracer.core.aop.BizTraceAspect;
import com.hexing.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "hexing.tracer", value = "enable", matchIfMissing = true)
public class HxTracerAutoConfiguration {
